export const portfolioData = {
  profile: {
    ...
    bio: "Computer Science undergraduate with the capability of building an idea from concept to a shipping real-world product. Expert in Full-Stack development (MERN, Next.js) and AI Automation (n8n, LangChain, RAG).",
    contact: {
      phone: "+91-6300614592",
